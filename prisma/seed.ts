...
const TEAMS = [
  {
    ...
    shortName: "Broncos",
    aliases: ["Brisbane Broncos", "Broncos", "Brisbane", "Brisbane Broncs", "BRI"],
  },
  {
    slug: "canberra-raiders",
    name: "Canberra Raiders",
    shortName: "Raiders",
    aliases: ["Canberra Raiders", "Raiders", "Canberra", "CBR"],
  },
  {
    ...
    aliases: [
      ...
      "Canterbury Bankstown Bulldogs", // TheSportsDB (no hyphen)
  ...
  },
  {
    ...
    shortName: "Sharks",
    aliases: ["Cronulla Sharks", "Sharks", "Cronulla", "Cronulla-Sutherland Sharks", "Cronulla-Sutherland", "CRO"],
  },
  {
    slug: "gold-coast-titans",
    name: "Gold Coast Titans",
    shortName: "Titans",
    aliases: ["Gold Coast Titans", "Titans", "Gold Coast", "GLD"],
  },
  {
    slug: "manly-sea-eagles",
    name: "Manly Sea Eagles",
    shortName: "Sea Eagles",
    aliases: ["Manly Sea Eagles", "Sea Eagles", "Manly", "Manly-Warringah Sea Eagles", "Manly Warringah Sea Eagles", "MAN"],
  },
  {
    slug: "melbourne-storm",
    name: "Melbourne Storm",
    shortName: "Storm",
    aliases: ["Melbourne Storm", "Storm", "Melbourne", "MEL"],
  },
  {
    slug: "newcastle-knights",
    name: "Newcastle Knights",
    shortName: "Knights",
    aliases: ["Newcastle Knights", "Knights", "Newcastle", "NEW"],
  },
  {
    slug: "new-zealand-warriors",
    name: "New Zealand Warriors",
    shortName: "Warriors",
    aliases: ["New Zealand Warriors", "Warriors", "NZ Warriors", "New Zealand", "WAR"],
  },
  {
    slug: "north-queensland-cowboys",
    name: "North Queensland Cowboys",
    shortName: "Cowboys",
    aliases: ["North Queensland Cowboys", "Cowboys", "North Queensland", "NQ Cowboys", "NQL"],
  },
  {
    slug: "parramatta-eels",
    name: "Parramatta Eels",
    shortName: "Eels",
    aliases: ["Parramatta Eels", "Eels", "Parramatta", "PAR"],
  },
  {
    slug: "penrith-panthers",
    name: "Penrith Panthers",
    shortName: "Panthers",
    aliases: ["Penrith Panthers", "Panthers", "Penrith", "PEN"],
  },
  {
    slug: "south-sydney-rabbitohs",
    name: "South Sydney Rabbitohs",
    shortName: "Rabbitohs",
    aliases: ["South Sydney Rabbitohs", "Rabbitohs", "South Sydney", "Souths", "SOU"],
  },
  {
    ...
    aliases: [
      ...
      "St George",
      "St. George",
      "St. George Illawara Dragons", // TheSportsDB typo (one 'r')
      "St George Illawara Dragons",  // TheSportsDB typo (one 'r')
      "SGI",
    ],
  },
  {
    ...
    shortName: "Roosters",
    aliases: ["Sydney Roosters", "Roosters", "Sydney", "Eastern Suburbs Roosters", "SYD"],
  },
  {
    slug: "wests-tigers",
    name: "Wests Tigers",
    shortName: "Tigers",
    aliases: ["Wests Tigers", "Tigers", "Wests", "Balmain-Wests", "WST"],
  },
  {
    slug: "dolphins",
    name: "The Dolphins",
    shortName: "Dolphins",
    aliases: ["The Dolphins", "Dolphins", "Redcliffe Dolphins", "Redcliffe", "DOL"],
  },
];
